    ...
    if (!books || books.length === 0) {
      return (
        <section className="mb-10 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-white capitalize px-1 sm:px-2 mb-3 sm:mb-4">
            {title}
          </h2>
...
function BookDetailModal({
  ...
  return (
    ...
    >
      <div
        className="bg-gradient-to-br from-[#2a283e] via-[#1c1a29] to-[#16141A] text-white rounded-xl shadow-2xl p-5 sm:p-6 md:p-8 max-w-xl lg:max-w-2xl w-full relative animate-fadeIn custom-modal-scroll"
